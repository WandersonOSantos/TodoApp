...
namespace Todo.Domain.Api.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        {
            return repository.GetAll("wanderson.osantos");
        }
        ...
        {
            return repository.GetAllDone("wanderson.osantos");
        }
        ...
        {
            return repository.GetAllUndone("wanderson.osantos");
        }
        ...
        public IEnumerable<TodoItem> GetDoneForToday([FromServices] ITodoRepository repository, string user)
        {
            ...
            return repository.GetByPeriod("wanderson.osantos", DateTime.Now.Date, true);
        }
        ...
        {
            // Usando o Date no final do DateTime.Now, a hora é excluída.
            return repository.GetByPeriod("wanderson.osantos", DateTime.Now.Date, false);
        }
        ...
        {
            // Usando o Date no final do DateTime.Now, a hora é excluída.
            return repository.GetByPeriod("wanderson.osantos", DateTime.Now.Date.AddDays(1), true);
        }
        ...
        {
            // Usando o Date no final do DateTime.Now, a hora é excluída.
            return repository.GetByPeriod("wanderson.osantos", DateTime.Now.Date.AddDays(1), false);
        }
        ...
        {
            command.User = "wanderson.osantos";
